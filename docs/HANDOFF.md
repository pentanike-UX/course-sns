...
- **현재 버전**: v0.3.24-mvp (`src/lib/version.ts`)
...
### P2·P3 시나리오 단계별 코드 감사 (Cursor, 2026-08-12 · v0.3.24-mvp)

- **버전**: **`v0.3.24-mvp`** (PATCH).
- **내용**: `PERSONA-SCENARIOS` §P2·§P3를 v0.3.23 코드에 단계별 대조. dirty confirm·CTA 톤·공개 게이트·SaveNotice replace는 OK. 잔여 GAP: 따라가는 중 카드→초안(완주 CTA 없음), 플래너 `FollowReadyHint` 누락, 통계 전이 0명 숨김·「다녀온 지역」톤, 공개 soft-only.
- **문서**: [`docs/PERSONA-SCENARIO-P2P3-AUDIT-v0323.md`](PERSONA-SCENARIO-P2P3-AUDIT-v0323.md).
- **검증**: 코드 동작 변경 없음(감사 문서).
