...
### Wave A — 의미 충돌 제거 (컬러·아이콘, 침습 낮음)

1. 보관함 탭 아이콘 하트 → 실행함 아이콘  
2. 지도 peek / TourCard: ♥ → 스펙 + 따라감/다녀옴  
3. 카드 좋아요 폴백 제거(또는 최하위)  
4. 에러 표면을 `--error-soft`로 통일  
5. 상태 뱃지(다녀옴/다듬는 중) 뉴트럴·브랜드 역할 재매핑  
