...
- [x] 보관함: **따라가는 중 | 저장 | 팔로잉**
- [x] 따라가는 중 = `route_copies` + 상태 뱃지(다듬는 중/기록 중/다녀옴) + 완주 유도 링크
- [x] 팔로잉 기본 = **새 코스 스트림** + 사람 서브탭
...
> **기준 코드:** course-sns MVP (`v0.3.3-mvp`, routdiary fork)  
> **관련:** 페르소나 P1 탐색러 · P2 따라가이 · P3 코스 메이커 · P4 영향력 구독자 · Playwright 실측 [`UX-PERSONA-PAINPOINTS.md`](UX-PERSONA-PAINPOINTS.md)
