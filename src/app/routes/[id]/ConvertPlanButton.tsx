...
/**
 * Owner-only header action on a plan draft: "여행 다녀왔어요". Confirming converts
 * the plan into a travel record so photos and a diary can be added.
 */
  ...
  return (
    <>
      ...
      <ActionBottomSheet
        open={open}
        title="여행 다녀오셨어요?"
        description="기록으로 바꾸면 사진과 코스 메모를 더해 이 계획을 완성할 수 있어요."
        primaryLabel="기록으로 전환하기"
