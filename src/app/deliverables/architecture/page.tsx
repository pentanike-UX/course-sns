    ...
    <>
      ...
      <DocTable
        ...
        rows={[
          ...
          ["지도", "국내: 네이버 타일+경로. 해외: 구글 타일+전 수단. 코딩은 docs/routing 키트"],
      ...
      <Note>
        ...
        build는 lint를 돌리지 않음 → 검증 시 <Code>pnpm lint</Code> 별도. 지도 경로는{" "}
        <Code>docs/MAP-ROUTING.md</Code> §0 + <Code>docs/routing/README.md</Code> — 국내 네이버, 해외
        구글 전 수단.
      </Note>
    </>
  );
