...
export default function ChangelogPage() {
  return (
    <>
      ...
      <Ul>
        <li>
          도보를 골라도 지도가 자동차 도로를 그리는 이유(네이버 Directions는 자동차만, TMAP 키 없으면
          폴백)와 도보·자전거·버스·지하철·기차로 길을 잇는 방법만 개발 가이드에 기록. 구현 없음
        </li>
        <li>
          같은 날 시나리오 테스트: 홈·상세·지도 지연 없음. 등록 2–4번 헤더 X가 위자드를 닫던 문제는
          v0.4.7에서 수정
        </li>
      </Ul>
