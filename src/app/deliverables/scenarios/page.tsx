    ...
    <>
      ...
      <DocTable
        ...
        rows={[
          ...
          ["P4", "영향력 구독자", "믿을 메이커 신작을 받는다", "책장 · 팔로잉", "팔로우 → 따라가기"],
      ...
      <Ul>
        ...
        <li>
          <strong className="font-semibold text-ink">P1-b</strong> 홈「팔로잉의 새 코스」레일 → 상세 →
          따라가기
        </li>
        <li>
      ...
      <DocTable
        ...
        rows={[
          ["1", "작성자 책장", "/u/[handle]"],
          ["2", "팔로우", "맞팔 라벨 가능"],
          ["3", "보관함「팔로잉」", "새 코스 스트림 우선"],
          ["4", "(또는) 홈 팔로잉 레일", "데이터 있을 때"],
