...
const FAQ = [
  ...
  {
    q: "보관함에는 뭐가 있나요?",
    a: "따라가는 중(내가 가져온 초안)·저장(아직 안 따라간 북마크)·구독 코스(팔로우한 메이커의 새 코스)가 있어요. 저장 카드에서 바로 따라가거나 해제할 수 있어요.",
  },
  {
    q: "좋아요는 어디에 쓰이나요?",
    a: "코스 상세에서 가볍게 반응하는 보조 신호예요. 핵심은 따라가기·다녀왔어요이고, 보관함에는 좋아요 모아보기가 없어요.",
  },
  {
    q: "프로필 사진과 닉네임을 바꾸고 싶어요.",
    a: "설정(프로필)의 ‘프로필 편집’에서 아바타·닉네임·핸들을 바꿀 수 있어요.",
  },
];
