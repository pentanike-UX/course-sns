...
const FAQ = [
  {
    q: "루트가 뭔가요?",
    a: "하루의 여정을 순서대로 묶은 기록이에요. 스팟(장소)들과 그 사이의 이동(도보·자가용·지하철 등)을 함께 담아요.",
  },
  {
    q: "비공개와 공개의 차이는?",
    a: "비공개 루트는 나만 볼 수 있는 코스예요. 공개로 바꾸면 둘러보기 피드에 노출되고 다른 사람이 좋아요·저장·댓글을 남길 수 있어요.",
  },
  {
    q: "지도에 경로는 어떻게 그려지나요?",
  ...
  },
  {
    ...
    a: "하단 탭의 보관함에서 저장·좋아요한 루트를 모아 볼 수 있어요. 카드의 아이콘을 누르면 바로 해제돼요.",
  },
  {
